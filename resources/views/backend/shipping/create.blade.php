            ...
            <div class="row">
                <div class="col-lg-6 col-md-8 col-sm-12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="{{route('shipping.index')}}">List of Shipping</a></li>
                            ...
                            <div class="row clearfix">
                                <div class="col-lg-12 col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="shipping_address" class="form-control" value="{{old('shipping_address')}}" placeholder="Shipping Address">
                                ...
                                <div class="col-lg-12 col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="delivery_time" class="form-control" value="{{old('delivery_time')}}" placeholder="Delivery Time">
                                        @error('delivery_time')
                                        <p class="text-danger">{{$message}}</p>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-lg-12 col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="number" step="any" name="delivery_charge" class="form-control" value="{{old('delivery_charge')}}" placeholder="Delivery Charge">
