            ...
            <div class="row">
                <div class="col-lg-6 col-md-8 col-sm-12">
                    <h2><a href="javascript:void(0);" class="btn btn-xs btn-link btn-toggle-fullwidth"><i class="fa fa-arrow-left"></i></a> shipping
                        <a href="{{route('shipping.create')}}" class="btn btn-outline-secondary"><i class="icon-plus"></i> shipping Coupon</a>
                    </h2>
                    <ul class="breadcrumb float-left ">
                        <li class="breadcrumb-item" ><a href="{{route('admin')}}"><i class="icon-home "></i></a></li>
                        <li class="breadcrumb-item px-1 active"> list of shipping</li>
                    </ul>
                    <p class="float-right">Total Category :{{\App\Models\Shipping::count()}}</p>
                </div>
            </div>
        </div>
