        ...
        <div class="block-header">
            <div class="row">
                <div class="col-lg-6 col-md-8 col-sm-12">
                    <h2><a href="javascript:void(0);" class="btn btn-xs btn-link btn-toggle-fullwidth"><i class="fa fa-arrow-left"></i></a> Coupon
                        <a href="{{route('coupon.create')}}" class="btn btn-outline-secondary"><i class="icon-plus"></i> Create Coupon</a>
                    </h2>
                    <ul class="breadcrumb float-left ">
                        <li class="breadcrumb-item" ><a href="{{route('admin')}}"><i class="icon-home "></i></a></li>
                        <li class="breadcrumb-item px-1 active">Coupon</li>
                    </ul>
                    <p class="float-right">Total Category :{{\App\Models\Coupon::count()}}</p>
                </div>
            </div>
        </div>
